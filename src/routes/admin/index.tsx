...
import { Images, Newspaper, Settings } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Welcome to the Shammah Innovation Holdings admin portal.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Link to="/admin/services" className="transition-transform hover:scale-[1.02]">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">Manage</div>
              <p className="text-xs text-muted-foreground">Update service capabilities and details.</p>
            </CardContent>
          </Card>
        </Link>
      </div>
