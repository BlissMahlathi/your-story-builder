  ...
  return (
    <footer className="bg-navy-deep text-primary-foreground/75">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          <h2 className="font-display text-sm font-semibold uppercase tracking-[0.2em] text-gold">Company</h2>
          <ul className="mt-4 space-y-2 text-sm">
            <li><Link to="/about" className="hover:text-gold">About Us</Link></li>
            <li><Link to="/services" className="hover:text-gold">Our Services</Link></li>
            <li><Link to="/gallery" className="hover:text-gold">Project Gallery</Link></li>
            <li><Link to="/news" className="hover:text-gold">News &amp; Blog</Link></li>
          </ul>
        </div>

        <div>
          <h2 className="font-display text-sm font-semibold uppercase tracking-[0.2em] text-gold">Get Started</h2>
          <ul className="mt-4 space-y-2 text-sm">
        ...
        <div>
          <h2 className="font-display text-sm font-semibold uppercase tracking-[0.2em] text-gold">Contact</h2>
          <ul className="mt-4 space-y-3 text-sm">
            ...
            <li className="flex gap-3">
              ...
              <a href={`mailto:${COMPANY.email}`} className="break-all hover:text-gold">{COMPANY.email}</a>
            </li>
            <li className="flex gap-3">
