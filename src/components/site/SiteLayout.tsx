      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        {breadcrumb ? (
          <nav
            ...
            className="mt-6 flex items-center gap-2 text-xs uppercase tracking-wide text-primary-foreground/70"
          >
...
export function SectionHeading({
  ...
  return (
    <div className={center ? "mx-auto max-w-2xl text-center" : "max-w-2xl"}>
      ...
      <h2 className="mt-2 font-display text-3xl font-bold uppercase tracking-tight text-navy md:text-4xl">
        {title}
      </h2>
      {description ? (
